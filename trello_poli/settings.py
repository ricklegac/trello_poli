"""
Django settings for trello_poli project.
...
SECRET_KEY = 'django-insecure-0d%aibo@cv--er0mx#nk0-^k94knbgy7qgwc=s+jwwzteq2&%l'
...
WSGI_APPLICATION = 'trello_poli.wsgi.application'
